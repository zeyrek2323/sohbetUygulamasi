  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f5f6fa', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: 350, background: '#fff', borderRadius: 18, boxShadow: '0 4px 24px rgba(0,0,0,0.08)', padding: 32, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <h2 style={{ fontSize: 32, fontWeight: 700, marginBottom: 8, color: '#222', textAlign: 'center' }}>Kayıt Ol</h2>
        <p style={{ color: '#888', fontSize: 16, marginBottom: 28, textAlign: 'center' }}>Yeni bir hesap oluşturun</p>
        ...
        <div style={{ marginTop: 6 }}>
          <span style={{ color: '#888', fontSize: 15 }}>Zaten hesabınız var mı? </span>
          <Link to="/login" style={{ color: '#2196f3', fontWeight: 600, textDecoration: 'none' }}>Giriş yap</Link>
        </div>
      </div>
    </div>
  );
